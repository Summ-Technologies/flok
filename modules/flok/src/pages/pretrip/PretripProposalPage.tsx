import {Box, Hidden, Icon, Link, makeStyles, Paper} from "@material-ui/core"
...
type PretripProposalPageProps = RouteComponentProps<{
  hotelGuid: string
}>
function PretripProposalPage(props: PretripProposalPageProps) {
  let classes = useStyles(props)

  let hotelGuid = convertGuid(props.match.params.hotelGuid)
  let [hotel, loadingHotel] = useHotel(hotelGuid)
  let retreatGuid = Constants.demoRetreatGuid
      ...
      {retreat === ResourceNotFound ? (
        ...
        <PageOverlay
          ...
          <Link
            ...
            underline="none"
            color="inherit"
            to={AppRoutes.getPath("PretripLodgingProposalsPage")}>
            <Icon>
              <ArrowBackIos />
            </Icon>
            Proposals
...
export default withRouter(PretripProposalPage)
